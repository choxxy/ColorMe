...
public class ColorUtils {
    ...
    private static List<ColorItem> initColorList() {
        ...
        Collections.sort(colors, (c1, c2) -> (c1.getMse() - c2.getMse()));

        /*for (int i = 0; i < colors.size(); i++) {
            Log.d("MSE", "" + colors.get(i).getMse());
        }*/
    ...
    private static ColorItem binarySearch(List<ColorItem> colorItems, int start, int size, int x) {
        if (size >= start) {
            ...
            if (colorItems.get(mid).getMse() > x)
                return binarySearch(colorItems, start, mid - 1, x);

            // Else the element can only be present
            // in right subarray
            return binarySearch(colorItems, mid + 1, size, x);
        }
    ...
    public static String getColorNameFromRgb(String hex) {
        ...
        ColorItem item = binarySearch(colorList, 0, colorList.size(), x);
    ...
    public static class ColorItem {
        ...
        public ColorItem(String name, String hexValue, int mse) {
            this.hex = hexValue;
            this.name = name;
            this.mse = mse;
        }
